...
const ZoomboxImage = ({ src, alt, zoom, xPercentage, yPercentage, setZoom, enableImageDragBeta, dbClickToZoom }) => {
    ...
    return (React.createElement("div", { draggable: false, ref: image, style: Object.assign({ transform: `scale(${zoom})`, transformOrigin: `${xPercentage}% ${yPercentage}%` }, (enableImageDragBeta && isDown ? { cursor: 'grabbing' } : {})), className: "imageContainer" },
...
const Zoombox = (props) => {
    ...
    return active && selectedImage ? (React.createElement("div", { ref: zoomboxElement, className: "zoombox", style: { zIndex: zIndex } },
        ...
        React.createElement(ZoomboxImage, Object.assign({ src: selectedImage.src, alt: selectedImage.caption }, { xPercentage, yPercentage, setZoom, zoom, enableImageDragBeta, dbClickToZoom })),
