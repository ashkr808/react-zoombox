...
const Zoombox = (props) => {
    const { images, active, setActive, selectedImage: selectedIndex = 0, zIndex = 10000, enableKeyboadNavigation = false, maskClosable = true, enableZoom = 0 } = props;
    ...
    return active ? (React.createElement("div", { ref: zoomboxElement, className: "zoombox", style: { zIndex: zIndex } },
        ...
        React.createElement(ZoomboxControls, Object.assign({}, { nextPrevImage, setZoomValue, enableZoom })),
