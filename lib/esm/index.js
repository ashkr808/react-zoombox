...
const ZoomBoxFooter = (props) => {
    ...
    return (React.createElement("div", { className: "footer" },
        React.createElement("div", { className: "previewImagesContainer", style: { transform: `translateX(${translateX}px)` } }, images.map((image, index) => (React.createElement("img", { key: index, alt: image.caption, src: image.src, onClick: () => handleImageClick(index), className: selectedImage === index ? "activeImage" : "" }))))));
};
...
const Zoombox = (props) => {
    ...
    return (React.createElement("div", { className: "zoombox", style: { display: `${active ? "block" : "none"}` } },
        React.createElement("div", { onClick: handleClose, className: "closeOverlay" }),
        React.createElement(ZoomboxHeader, null),
        React.createElement("div", { className: "imageContainer" },
            React.createElement("img", { src: images[selectedImage].src, alt: "" })),
        React.createElement(ZoomboxCaption, { text: images[selectedImage].caption }),
