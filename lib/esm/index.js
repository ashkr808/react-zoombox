...
const ZoomboxImage = ({ src, alt, zoom }) => {
    return (React.createElement("div", { style: { transform: `scale(${zoom})` }, className: "imageContainer" },
...
const Zoombox = (props) => {
    ...
    return active ? (React.createElement("div", { ref: zoomboxElement, className: "zoombox", style: { zIndex: zIndex } },
        ...
        React.createElement(ZoomboxImage, { src: selectedImage.src, alt: selectedImage.caption, zoom: zoom }),
