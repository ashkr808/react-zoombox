...
const Zoombox = (props) => {
    ...
    return active ? (React.createElement("div", { className: "zoombox", style: { zIndex: zIndex } },
        ...
        React.createElement(ZoomBoxFooter, Object.assign({}, { images, setSelectedImage, selectedImage, selectedIndex, translateX, setTranslateX, selectedImageIndex })),
        React.createElement(ZoomboxControls, Object.assign({}, { nextPrevImage })),
