...
const ZoomboxCredits = () => {
    return (React__default["default"].createElement("div", { className: "ZoomboxCredits" },
        "Image preview powered by",
        ' ',
        React__default["default"].createElement("a", { href: "https://worldsofashishpatel.com/projects/zoombox/", target: '_blank', rel: "noopener noreferrer" }, "Zoombox")));
};
...
const ZoomboxImage = ({ src, alt, zoom, xPercentage, yPercentage, setZoom, enableImageDrag, dbClickToZoom }) => {
    ...
    return (React__default["default"].createElement("div", { draggable: false, ref: image, style: Object.assign({ transform: `scale(${zoom})`, transformOrigin: `${xPercentage}% ${yPercentage}%` }, (enableImageDrag && zoom >= ENABLE_DRAG_AT_ZOOM ? { cursor: isDown ? 'grabbing' : 'grab' } : {})), className: "imageContainer" },
...
const Zoombox = (props) => {
    ...
    return active && selectedImage ? (React__default["default"].createElement("div", { ref: zoomboxElement, className: "zoombox", style: { zIndex: zIndex } },
        ...
        React__default["default"].createElement(ZoomboxImage, Object.assign({ src: selectedImage.src, alt: selectedImage.caption }, { xPercentage, yPercentage, setZoom, zoom, enableImageDrag, dbClickToZoom })),
        ...
        showCredits && React__default["default"].createElement(ZoomboxCredits, null),
